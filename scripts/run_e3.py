...
def _md(summary: dict) -> str:
    lines = [
        ...
        "Paper overall cells are median [p25, p75]. Robustness under dynamic mix, not Proposed-dominance.",
        "Latency is safety-stage, not user E2E. UAR residual is MiniLM FN and/or G_strong miss.",
        "",
        "## Overall (median [IQR])",
        "",
